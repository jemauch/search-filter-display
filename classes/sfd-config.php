...
class SFD_Config {
    ...
    public function __construct() {
        ...
        $this->orderConfig = [
            'archive_inventory' => 'inventory_year.meta_value DESC, inventory_volume.meta_value DESC, CAST(inventory_number.meta_value AS int) DESC, inventory_number.meta_value DESC',
